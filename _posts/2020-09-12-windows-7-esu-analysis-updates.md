...
### Installing KB5020000 (November 2022 Cumulative Update)

The November 2022 Cumulative Update includes new ESU files that bump versions past those used in KB4528069.  However, the same technique that previously applied still works.
...
3. If using the failed reboot technique, try to install KB50200000 and let it fail.  Apply the updated SideBySide registry key below and retry the update.  This time it will succeed.
