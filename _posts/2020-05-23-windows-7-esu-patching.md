...
> I highly recommend both the [KUC Update Checker](https://windows-update-checker.com/) and [WSUS Offline Update](https://www.wsusoffline.net/) utilities.  I used both during this investigation in order to get to this minimum required set.  
...
| KB2647644 | AD Certificate Use Issuer Update             | You cannot clear the "Use Issuer for alternate security identity" check box in Windows 7 SP1. | [Windows6.1-KB2647644-x64.msu](https://github.com/HackAndPwn/Windows-7-Patching/raw/master/03_Feature_AD_LDS/04_Windows6.1-KB2647644-x64.msu) |
